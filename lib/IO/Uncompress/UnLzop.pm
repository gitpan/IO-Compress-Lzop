...
use IO::Uncompress::Adapter::LZO ;
use Compress::LZO qw(crc32 adler32);
use IO::Compress::Lzop::Constants ;
...
sub postBlockChk
{
    ...
    if (*$self->{Strict} && *$self->{LzopData}{Flags} & FLAG_CRC_UNCOMP
        ...
        my $crc ;
        $crc = crc32($$buffer)   if *$self->{LzopData}{Flags} & F_CRC32_D ;
        $crc = adler32($$buffer) if *$self->{LzopData}{Flags} & F_ADLER32_D ;
...
L<Compress::Zlib>, L<IO::Compress::Gzip>, L<IO::Uncompress::Gunzip>, L<IO::Compress::Deflate>, L<IO::Uncompress::Inflate>, L<IO::Compress::RawDeflate>, L<IO::Uncompress::RawInflate>, L<IO::Compress::Bzip2>, L<IO::Uncompress::Bunzip2>, L<IO::Compress::Lzop>, L<IO::Uncompress::AnyInflate>, L<IO::Uncompress::AnyUncompress>
